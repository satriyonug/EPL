...
class Peserta extends Model
{
    ...
    protected $fillable = ['id_instruktur','evaluasi', 'id', 'id_jadwal', 'nama', 'jenis_kelamin', 'tanggal_lahir','evaluasi', 'foto_peserta', 'alamat', 'nomor_telepon', 'verifikasi', 'sisa_kursus'];
